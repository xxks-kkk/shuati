...
/***
 * This function performs the same task as LC285. However, unlike 285,
 * it only needs one parameter, a node that needs to be searched for its successor. The reason we can do so
 * because we have access to the parent pointer.
